...
### 2. Ejemplos de Conjuntos Convexos Básicos
...
### 3. Operaciones que Conservan la Convexidad
...
### 4. Envoltura Convexa y Símplices
...
### 1. Teoremas de Separación de Hiperplanos
...
### 2. Teorema del Hiperplano de Soporte
...
### 2. Operaciones que Preservan la Convexidad de Funciones
...
-   **Subgradiente y Subdiferencial**:
    ...
    El subdiferencial $\partial f(x_0)$ es siempre un conjunto convexo y cerrado. Si la función es diferenciable en $x_0$, el subdiferencial contiene un único elemento que es el gradiente: $\partial f(x_0) = \{\nabla f(x_0)\}$.
...
### 1. Caracterización de Primer Orden
...
### 2. Caracterización de Segundo Orden (Hessiana)
...
### 1. El Teorema Fundamental de la Optimización Convexa
...
### 2. Condición Variacional de Optimalidad
