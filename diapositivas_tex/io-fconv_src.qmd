...
Restando la segunda expresi\'{o}n a la primera, se obtiene:
    ...
    $$
Dividiendo por $ºlambda^2>0$ y tomando l\'{\i}mites cuando $\lambda\rightarrow 0$ se tiene que
...
M\'{a}s a\'{u}n, si $\SS$ es abierto, entonces $\ovx$ es \'{o}ptimo si y s\'{o}lo si $\gf(\ovx)º=\vv$.
\end{corolario}
