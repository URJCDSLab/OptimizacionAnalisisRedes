...
### 1. El Problema de Königsberg (Euler, 1736)
...
### 2. Definición Formal de un Grafo
-   **Grafo No Dirigido**:
...
### 3. Subgrafos, Conectividad y Grados
-   **Subgrafo**:
...
### 1. Representación Geométrica y Grafos Planares
