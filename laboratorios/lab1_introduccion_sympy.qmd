...
*Ayuda de análisis*:
Los autovalores calculados de la hessiana son aproximadamente $\lambda_1 \approx 8.427$, $\lambda_2 \approx -4.379$ y $\lambda_3 \approx 1.951$. Al existir autovalores de signo opuesto (positivos y negativos), la matriz hessiana es **indefinida** y la función **no es convexa ni cóncava** en $\mathbb{R}^3$ (el origen constituye un punto de silla).
...
Los menores principales son $M_1 = 8x_2 - 24x_1^2 \le 0$ y $M_2 = \det(\mathbf{H}_f) = -32x_2 + 32x_1^2 \ge 0$. Resolviendo las desigualdades se obtiene que la función es cóncava en la región donde:
$$ x_2 \le x_1^2 $$
