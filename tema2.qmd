...
::: {#fig-superficies-3d-ejemplos layout-ncol=3}
![Representación 3D y curvas de nivel de un punto de silla (Hessiana indefinida)](images/punto_silla_3d.png){#fig-superficies-3d-silla}

![Representación 3D y curvas de nivel de un mínimo circular (Hessiana definida positiva)](images/funcion_distancia_3d.png){#fig-superficies-3d-circular}

![Representación 3D y curvas de nivel de un mínimo elíptico (Hessiana definida positiva)](images/funcion_cuadratica_3d.png){#fig-superficies-3d-eliptica}

Visualización geométrica en 3D y curvas de nivel para el análisis local de curvatura y clasificación de puntos estacionarios
:::
