...
::: {.callout-note title="Ejemplos: Clasificación de Matrices"}
...
::: {.callout-note title="Ejemplos: Clasificación de Puntos Estacionarios"}
...
![Minimización de la función de cuarto grado y su mínimo global en $x^* = 3.0$](images/opt_1d_ejemplo.png){#fig-opt-1d-ejemplo fig-align="center" width="60%"}

::: {.callout-note title="Ejemplo: Búsqueda Dicotómica"}
...
::: {.callout-note title="Ejemplo: Sección Áurea"}
...
::: {.callout-note title="Ejemplo: Búsqueda de Fibonacci"}
...
::: {.callout-note title="Ejemplo: Método de Bisección"}
...
::: {.callout-note title="Ejemplo: Método de Newton 1D"}
...
::: {.callout-note title="Ejemplo: Coordenadas Cíclicas"}
...
*   **Variables Acopladas**:
    ...
    *   *Paso 2*: Minimizamos respecto a $y$ manteniendo $x = 1.5625$:
        $$ \min_{y} \quad f(1.5625, y) = 7y^2 + 35.6875y + \text{ct} \implies 14y + 35.6875 = 0 \implies y = -\frac{571}{224} \approx -2.5491 $$
        Lo que resulta en el punto $x_2 = (1.5625, -2.5491)^T$.
    *   *Paso 3*: Minimizamos de nuevo respecto a $x$ con $y = -2.5491$:
        $$ \min_{x} \quad f(x, -2.5491) = 8x^2 - 32.6473x + \text{ct} \implies 16x - 32.6473 = 0 \implies x_3 = (2.0405, -2.5491)^T $$
...
::: {.callout-note title="Ejemplo: Máximo Descenso"}
