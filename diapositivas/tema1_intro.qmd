...
# Introducción a la investigación operativa {background-gradient="linear-gradient(135deg, #0f172a 0%, #1e1b4b 40%, #0369a1 100%)"}
...
# El concepto de modelo {background-gradient="linear-gradient(135deg, #0f172a 0%, #1e1b4b 40%, #0369a1 100%)"}
...
# Modelos de optimización {background-gradient="linear-gradient(135deg, #0f172a 0%, #1e1b4b 40%, #0369a1 100%)"}
...
# Optimización no lineal y en redes {background-gradient="linear-gradient(135deg, #0f172a 0%, #1e1b4b 40%, #0369a1 100%)"}
