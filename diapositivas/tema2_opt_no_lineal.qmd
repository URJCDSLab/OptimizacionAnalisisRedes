  ...
  revealjs:
    ...
    footer: |
      <div class="footer-container">
        <span class="footer-left">Víctor Aceña / Antonio Alonso</span>
        <span class="footer-center">Optimización y Análisis de Redes</span>
        <span class="footer-right">Tema 2: optimización no lineal y métodos numéricos</span>
      </div>
---
...
*   Reduce el intervalo a prácticamente la mitad en cada paso:
...
*   **Paso 1**: $[a_0, b_0] = [1, 4]$. Punto medio $c = 2.5$.
    ...
    *   $\lambda_0 = 2.48 \implies f(2.48) = -68.397$
    *   $\mu_0 = 2.52 \implies f(2.52) = -68.490$
    *   Como $f(\lambda_0) > f(\mu_0)$, descartamos $[a_0, \lambda_0]$. Nuevo intervalo: $[2.48, 4]$.
...
*   Optimiza la búsqueda dicotómica reutilizando puntos de evaluación en pasos sucesivos.
*   La amplitud del intervalo se reduce por la razón áurea $1/\alpha \approx 0.618$:
...
*   **Paso 1**: $[a_0, b_0] = [1, 4]$. Amplitud $I_1 = 3 / 1.618 = 1.8541$.
    
    *   $\lambda_0 = 4 - 1.8541 = 2.1459 \implies f(2.1459) = -66.692$.
    *   $\mu_0 = 1 + 1.8541 = 2.8541 \implies f(2.8541) = -68.714$.
    *   $f(\lambda_0) > f(\mu_0) \implies$ nuevo intervalo: $[2.1459, 4]$.
...
*   Trazado para $N=6$ ($F_7 = 21$):
    
    *   **Paso 1**: $[a_0, b_0] = [1, 4]$. Paso $I_1 = \frac{13}{21} \cdot 3 \approx 1.8571$.
        $\lambda_0 = 4 - 1.8571 = 2.1429 \implies f(2.1429) = -66.673$, $\mu_0 = 1 + 1.8571 = 2.8571 \implies f(2.8571) = -68.715$.
        $f(\lambda_0) > f(\mu_0) \implies$ nuevo intervalo: $[2.1429, 4]$.
...
Aproxima la función mediante su polinomio de Taylor cuadrático en el punto actual $x_k$ y salta al vértice de la parábola:
...
*   **Paso 1**: Partimos de $x_0 = 1.0$.
    ...
    *   $f'(1) = -30.0$, $f''(1) = 31.0$.
    *   $x_1 = 1.0 - (-30.0 / 31.0) \approx 1.9677$.
*   **Paso 2**: $x_1 = 1.9677$.
...
## Método de coordenadas cíclicas: variables desacopladas
...
## Método de coordenadas cíclicas: variables acopladas
...
*   **Paso 1**: Optimizamos respecto a $x$ con $y=0$:
    
    *   $\min_x \quad f(x, 0) = 8x^2 - 25x - 29$
    *   Derivando: $16x - 25 = 0 \implies x_1 = (1.5625, 0)^T$.
*   **Paso 2**: Optimizamos respecto a $y$ con $x=1.5625$:
    
    *   $\min_y \quad 7y^2 + 35.6875y + \text{ct}$
...
La ortogonalidad obligada por la búsqueda exacta provoca un patrón de zigzag ineficiente sobre elipses estrechas:
...
*   **Paso 1**: Gradiente en $x_0$:
    
    *   $\nabla f(x_0) = (16x+3y-25, 3x+14y+31)^T_{(0,0)} = (-25, 31)^T$.
    *   Dirección: $d_0 = (25, -31)^T$.
...
*   **Paso 3**: Actualización:
    ...
    *   $x_1 = x_0 + \alpha_0 d_0 = (2.109, -2.615)^T$.
