...
*   **Paso 2**: $[a_1, b_1] = [2.48, 4]$. Punto medio $c_1 = 3.24$.
    ...
    *   Calculamos evaluaciones:
        $$ f(3.22) \approx -68.730 \qquad f(3.26) \approx -68.683 $$
...
*   **Paso 3**: $[a_2, b_2] = [2.48, 3.26]$. Punto medio $c_2 = 2.87$.
    ...
    *   Calculamos evaluaciones:
        $$ f(2.85) \approx -68.711 \qquad f(2.89) \approx -68.724 $$
...
*   **Paso 2**: Partimos del punto anterior $x_1 = 1.9677$.
    ...
    *   Calculamos primera y segunda derivada:
        $$ f'(1.9677) \approx -8.459 \qquad f''(1.9677) \approx 14.450 $$
    *   Sustituimos en la regla de Newton:
...
*   **Paso 3**: Partimos de $x_2 = 2.5529$.
    ...
    *   Calculamos derivadas: $f'(2.5529) \approx -2.235$, $f''(2.5529) \approx 7.177$.
...
## Newton multivariable: paso a paso numérico (pasos 1-2)
...
## Newton multivariable: paso a paso numérico (paso 3)
