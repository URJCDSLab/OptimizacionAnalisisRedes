...
title-slide-attributes:
  data-background-gradient: "linear-gradient(135deg, #0f172a 0%, #1e1b4b 40%, #0369a1 100%)"
---

# Introducción y formulación {background-gradient="linear-gradient(135deg, #0f172a 0%, #1e1b4b 40%, #0369a1 100%)"}
...
# Óptimos y análisis diferencial {background-gradient="linear-gradient(135deg, #0f172a 0%, #1e1b4b 40%, #0369a1 100%)"}
...
# Métodos de búsqueda unidimensional {background-gradient="linear-gradient(135deg, #0f172a 0%, #1e1b4b 40%, #0369a1 100%)"}
...
# Métodos multivariables {background-gradient="linear-gradient(135deg, #0f172a 0%, #1e1b4b 40%, #0369a1 100%)"}
