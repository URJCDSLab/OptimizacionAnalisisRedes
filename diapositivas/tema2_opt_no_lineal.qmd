...
![](../images/funcion_distancia_3d.png){width="100%"}
:::

::: {.column width="50%"}
**Mínimo Elíptico ($H \succ 0$)**
![](../images/funcion_cuadratica_3d.png){width="100%"}
:::
:::
...
![](../images/punto_silla_3d.png){fig-align="center" width="75%"}
...
![](../images/opt_1d_ejemplo.png){fig-align="center" width="70%"}
...
<iframe src="../images/busqueda_uniforme_player.html" style="width:100%; height:520px; border:none; display:block; margin:0 auto;" scrolling="no"></iframe>
:::

::: {.content-visible when-format="pdf"}
![](../images/busqueda_uniforme_concepto.png){fig-align="center" width="55%"}
:::
...
::: {.content-visible when-format="html"}
<iframe src="../images/dicotomica_player.html" style="width:100%; height:520px; border:none; display:block; margin:0 auto;" scrolling="no"></iframe>
:::

::: {.content-visible when-format="pdf"}
![](../images/dicotomica_pasos.png){fig-align="center" width="55%"}
:::
...
## Sección áurea: deducción del ratio $\alpha$ (1)

*   Queremos que la razón entre las amplitudes de iteraciones sucesivas sea constante:
    $$ I_k = \alpha I_{k+1} \qquad I_{k+1} = \alpha I_{k+2} \implies I_k = \alpha^2 I_{k+2} $$
...
## Sección áurea: deducción del ratio $\alpha$ (2)
...
*   **Paso 3**: $[a_2, b_2] = [2.1459, 3.2918]$. Amplitud $I_3 = 0.7082$.
    ...
    *   Calculamos el nuevo punto:
        $$ \lambda_2 = b_2 - I_3 = 3.2918 - 0.7082 = 2.5836 \implies f(2.5836) \approx -68.3861 $$
    *   Como $f(\lambda_2) > f(\mu_2) \implies$ descartamos $[a_2, \lambda_2]$. Nuevo intervalo: $[2.5836, 3.2918]$.
*   **Convergencia**: El proceso continúa de forma análoga. En el **paso 7**, la amplitud de búsqueda se reduce a $0.1033 \le 0.15$ (tolerancia alcanzada), con el óptimo localizado en el intervalo final $[2.91, 3.01]$.
...
::: {.content-visible when-format="html"}
<iframe src="../images/seccion_aurea_player.html" style="width:100%; height:520px; border:none; display:block; margin:0 auto;" scrolling="no"></iframe>
:::

::: {.content-visible when-format="pdf"}
![](../images/seccion_aurea_pasos.png){fig-align="center" width="55%"}
:::
...
*   Siguiendo la regla de adición para la reutilización de puntos, las amplitudes de intervalos sucesivos se van acumulando:
    $$ I_{N-2} = I_{N-1} + I_N \approx 3 I_N $$
    $$ I_{N-3} = I_{N-2} + I_{N-1} \approx 5 I_N $$
...
*   **Paso 2**: $[a_1, b_1] = [2.1429, 4]$. Paso $I_2 = \frac{F_5}{F_7}(b_0 - a_0) = \frac{8}{21} \cdot 3 = 1.1429$.
...
*   **Convergencia**: En el **paso 5**, el intervalo es $[2.9531, 3.0469]$ con una amplitud de $0.0938 \le 0.15$, alcanzando la tolerancia.
...
::: {.content-visible when-format="html"}
<iframe src="../images/biseccion_player.html" style="width:100%; height:520px; border:none; display:block; margin:0 auto;" scrolling="no"></iframe>
:::

::: {.content-visible when-format="pdf"}
![](../images/biseccion_pasos.png){fig-align="center" width="55%"}
:::
...
*   **Paso 3**: Partimos de $x_2 = 2.5529$.
    ...
    *   Calculamos derivadas: $f'(2.5529) \approx -2.2300$, $f''(2.5529) \approx 7.1760$.
...
*   **Paso 5**: $x_4 = 2.9808 \implies x_5 = 2.9808 - \frac{-0.059}{3.154} \approx 2.9995 \approx 3.0$.
...
::: {.content-visible when-format="html"}
<iframe src="../images/newton_1d_player.html" style="width:100%; height:520px; border:none; display:block; margin:0 auto;" scrolling="no"></iframe>
:::

::: {.content-visible when-format="pdf"}
![](../images/newton_1d_pasos.png){fig-align="center" width="55%"}
:::
...
*   **Paso 1**: $x_{-1} = 1.0$, $x_0 = 1.5$.
    *   Evaluamos derivadas: $f'(1.0) = -30.0 \qquad f'(1.5) = -16.875$.
...
![](../images/funcion_distancia_3d.png){fig-align="center" width="55%"}
...
![](../images/funcion_cuadratica_3d.png){fig-align="center" width="55%"}
...
*   **Paso 3**: Optimizamos respecto a $x$ fijando $y = -2.5491$:
    ...
    *   Sustituimos en la ecuación:
        $$ f(x, -2.5491) = 8x^2 - 32.647 x - 62.533 $$
    *   Derivamos respecto a $x$ e igualamos a cero:
...
::: {.content-visible when-format="html"}
<iframe src="../images/coordenadas_ciclicas_ej1_player.html" style="width:100%; height:520px; border:none; display:block; margin:0 auto;" scrolling="no"></iframe>
:::

::: {.content-visible when-format="pdf"}
![](../images/coordenadas_ciclicas_ej1.png){fig-align="center" width="55%"}
:::
...
::: {.content-visible when-format="html"}
<iframe src="../images/coordenadas_ciclicas_ej2_player.html" style="width:100%; height:520px; border:none; display:block; margin:0 auto;" scrolling="no"></iframe>
:::

::: {.content-visible when-format="pdf"}
![](../images/coordenadas_ciclicas_ej2.png){fig-align="center" width="55%"}
:::
...
::: {.callout-important title="Ortogonalidad"}
Si el tamaño de paso se calcula mediante búsqueda de línea exacta, las direcciones de búsqueda consecutivas son siempre ortogonales:
$$ d_k^T d_{k+1} = 0 $$
:::
* **Consecuencia geométrica**: El método avance generando un patrón en "zig-zag" característico con ángulos de 90° entre iteraciones sucesivas.
...
*   **Paso 2**: Búsqueda lineal exacta en la dirección $d_0 = (25, -31)^T$:
...
::: {.content-visible when-format="html"}
<iframe src="../images/steepest_descent_player.html" style="width:100%; height:520px; border:none; display:block; margin:0 auto;" scrolling="no"></iframe>
:::

::: {.content-visible when-format="pdf"}
![](../images/steepest_descent_pasos.png){fig-align="center" width="60%"}
:::
