...
![Una ruta hamiltoniana óptima que resuelve el problema del viajante (TSP) sobre un conjunto de ciudades](images/tsp_ruta.png){#fig-tsp-ruta fig-align="center" width="70%"}
